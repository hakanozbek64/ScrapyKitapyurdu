...
class BooksSpider(scrapy.Spider):
    ...
    page_count = 0
    start_urls = [
        "https://www.kitapyurdu.com/index.php?route=product/best_sellers&list_id=5&filter_in_stock=1&filter_in_stock=1&page=1"
    ]
    ...
    def parse(self, response):
        ...
        while (i < len(book_names)):
            ...
            self.file.write("kitap Yayınevi:" + book_publishers[i] +"\n")           
            self.file.write("-------------------------------------------\n")
            self.book_count += 1
